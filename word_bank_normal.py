...
bank = {
    ...
    "RATATOUILLE": "Remy is rat, but a great artist can come from anywhere, n'est pas?",
    "DESPICABLE ME": "Gru trying to be a supervillain",
    ...
    "ELLEN DEGENERES": "Voices Dory in \"Finding Nemo\" and \"Finding Dory\"",
    ...
    "BIG DIPPER": "Formed from the seven brighest stars in the Ursa Major constellation",
    
    # Sports
    "LACROSSE": "Official Summer sport of Canada",
    "LEBRON JAMES": "Played for the Cavaliers, Heat, back to the Cavaliers, and now the Lakers as of 2018",
