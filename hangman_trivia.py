...
# Prevents the debugger from screaming at me because there's no word bank at the start
class WordBank:
	word_bank = {"":""}
...
# Button to close the app from the game page
...
def player_input(input_letter):
	...
	while letterFound:
		...
		if "_ " not in new_game.display_list: # word correct guessed
